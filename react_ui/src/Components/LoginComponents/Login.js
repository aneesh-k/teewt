                      ...
                      <div className="col-md-9 col-lg-8 mx-auto">
                        ...
                        <form>
                          <div className="form-label-group">
                            <input  onChange={this.addData.bind(this)} type="email" name="emailId" id="inputEmail" className="form-control" placeholder="Email address" required />
                            <label htmlFor="inputEmail">Email address</label>
                          </div>
          
                          <div className="form-label-group">
                            <input  name="password" onChange={this.addData.bind(this)} type="password" id="inputPassword" className="form-control" placeholder="Password" required />
                            <label htmlFor="inputPassword">Password</label>
                          </div>          
                          
                          <button onClick={this.onLogin.bind(this)} className="btn btn-lg btn-primary btn-block btn-login text-uppercase font-weight-bold mb-2" type="submit">Sign in</button>
